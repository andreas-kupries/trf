...
\tcl{} allowing us to intercept any read/write call made by the user
...
\item	\cmd {binio}. See file \file {doc/binio.proposal}
	...
	\strong {Please note}: Due to the availability of the \cmd {binary}
	command in \tcl{} 8.x I have decided to remove the support for
	\cmd {binio} in the next release.
\end	{enumerate}
...
\item	Add the \cmd {bzip} compressor.
