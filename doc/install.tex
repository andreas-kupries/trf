...
\item	\strong {Memchan}. Trf can be used without, but the
	...
	source 	       & \url {ftp://ftp.westend.com/pub/aku/memchan1.4.tar.gz} \\ \hline
	source (win)   & \url {ftp://ftp.westend.com/pub/aku/memchan14.zip} \\ \hline
	binary (win32) & \url {ftp://ftp.westend.com/pub/aku/mchan14b.zip} \\ \hline
	\end {tabular}}
	\html{	\html{
	\begin{itemize}
	\item	\htmladdnormallink {source}{ftp://ftp.westend.com/pub/aku/memchan1.4.tar.gz}
	\item	\htmladdnormallink {source (win)}{ftp://ftp.westend.com/pub/aku/memchan14.zip}
	\item	\htmladdnormallink {binary (win32)}{ftp://ftp.westend.com/pub/aku/mchan14b.zip}
	\end{itemize}}}
