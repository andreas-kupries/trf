...
This is the installation manual of Tcl-Trf @VERSION@, as of
@DATE@. For a documentation of the available commands see \file
...
\item	A binary distribution for \win{} is available, see \url
	...
	4.2). Just copy its contents in a zlib source distribution,
...
\cmd {DES} support is based upon libdes, a freely available
implementation of this algorithm, written by Eric A. Young (\url
{eay@mincom.com}). I used version 3.23 directly. Higher versions are
part of \cmd {SSLeay}, Erics implementation of the \strong{S}ecure
\strong{S}ockets \strong{L}ayer.

The official FAQ page is \url
...
\begin {tabular} {l|l}\hline
     ...
     ftp://ftp.psy.uq.oz.au/pub/Crypto/SSLapps/PORT4-5 & porting notes \\ \hline
     http://www.psy.uq.oz.au/~ftp/Crypto/ssl.html & SSLeay Programmer Reference \\
\end {tabular}
