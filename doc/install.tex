...
\item	\strong {Memchan}. Trf can be used without, but the
	...
	source 	       & \url {ftp://ftp.westend.com/pub/aku/memchan1.2.tar.gz} \\ \hline
	source (win)   & \url {ftp://ftp.westend.com/pub/aku/memchan12.zip} \\ \hline
	binary (win32) & \url {ftp://ftp.westend.com/pub/aku/mchan12b.zip} \\ \hline
	\end {tabular}}
	\html{	\html{
	\begin{itemize}
	\item	\htmladdnormallink {source}{ftp://ftp.westend.com/pub/aku/memchan1.2.tar.gz}
	\item	\htmladdnormallink {source (win)}{ftp://ftp.westend.com/pub/aku/memchan12.zip}
	\item	\htmladdnormallink {binary (win32)}{ftp://ftp.westend.com/pub/aku/mchan12b.zip}
	\end{itemize}}}
